<?php
class desiderataLibrary_modules_ontologybuilder_service_FieldTypeService extends GlizyObject
{
	...
	public function __construct()
	{
        ...
        $path = $application->isAdmin() ? __Paths::get('APPLICATION_TO_ADMIN') : __Paths::get('APPLICATION');
		$this->source = $path.'config/fieldTypes.xml';
		...
		$cacheFileName = $cacheObj->verify( $this->source.'_'.org_glizy_ObjectValues::get('org.glizy', 'siteId' ), get_class( $this ) );
