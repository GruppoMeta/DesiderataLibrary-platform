<?php
class desiderataLibrary_modules_ontologybuilder_controllers_ajax_LoadEntity extends org_glizy_mvc_core_CommandAjax
{
    function execute($entityId)
    {
        ...
        $it = org_glizy_objectFactory::createModelIterator('desiderataLibrary.modules.ontologybuilder.models.Entity');
