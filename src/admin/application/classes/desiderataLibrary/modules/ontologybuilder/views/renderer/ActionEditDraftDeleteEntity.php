...
class desiderataLibrary_modules_ontologybuilder_views_renderer_ActionEditDraftDeleteEntity extends GlizyObject
{
    function renderCell( $key, $value, $row )
	{
        ...
        $output .= __Link::makeLinkWithIcon('actionEntities', 'btn-icon icon-wrench', array('title' => __T('GLZ_RECORD_EDIT'), 'entityTypeId' => $entityTypeId, 'entityId' => $entityId, 'action' => 'editDraft' ) );
