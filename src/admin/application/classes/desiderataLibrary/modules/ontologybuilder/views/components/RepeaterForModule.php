<?php
// quickfix
class desiderataLibrary_modules_ontologybuilder_views_components_RepeaterForModule extends desiderataLibrary_modules_ontologybuilder_views_components_Repeater
{
    function process()
    {
