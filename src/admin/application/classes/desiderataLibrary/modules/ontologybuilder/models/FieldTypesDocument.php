<?php
class desiderataLibrary_modules_ontologybuilder_models_FieldTypesDocument extends org_glizy_dataAccessDoctrine_ActiveRecordSimpleDocument {

    function __construct($connectionNumber=0) {
        parent::__construct($connectionNumber);
        $this->setTableName('field_types_tbl');
