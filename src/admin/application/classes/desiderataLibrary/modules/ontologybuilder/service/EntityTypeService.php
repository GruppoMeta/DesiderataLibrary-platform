<?php
class desiderataLibrary_modules_ontologybuilder_service_EntityTypeService extends GlizyObject
{
    ...
    public function init() {
		...
		$cacheFileName = $cacheObj->verify( org_glizy_ObjectValues::get('org.glizy', 'siteId' ), get_class( $this ));
    ...
    {
        $it = org_glizy_objectFactory::createModelIterator('desiderataLibrary.modules.ontologybuilder.models.RelationTypesDocument', 'all');
        ...
        $it = org_glizy_objectFactory::createModelIterator('desiderataLibrary.modules.ontologybuilder.models.Entity', 'allWithProperties');
