<?php
class desiderataLibrary_modules_ontologybuilder_controllers_ajax_SaveEntity extends org_glizy_mvc_core_CommandAjax
{
    ...
    function execute($entity)
    {
        ...
        $entityProperties = org_glizy_objectFactory::createModel('desiderataLibrary.modules.ontologybuilder.models.EntityProperties');
        ...
        $this->entityTypeService = $this->application->retrieveProxy('desiderataLibrary.modules.ontologybuilder.service.EntityTypeService');
        $this->entityTypeService->invalidate();

        //
        $skinAttributesVO = org_glizy_objectFactory::createObject('desiderataLibrary.modules.ontologybuilder.models.vo.SkinAttributesVO');
