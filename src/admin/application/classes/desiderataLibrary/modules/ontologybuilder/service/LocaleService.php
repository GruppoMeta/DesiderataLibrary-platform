<?php
class desiderataLibrary_modules_ontologybuilder_service_LocaleService extends GlizyObject
{
    ...
    public function rebuildLocale()
    {
        ...
        $it = org_glizy_objectFactory::createModelIterator('desiderataLibrary.modules.ontologybuilder.models.EntityLabelsDocument', 'all');
        ...
        foreach ($languageCodes as $languageCode) {
            ...
            file_put_contents(desiderataLibrary_modules_ontologybuilder_Paths::getLocalePath($languageCode), $out);
        }
