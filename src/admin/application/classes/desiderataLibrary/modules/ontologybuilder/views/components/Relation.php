<?php
class desiderataLibrary_modules_ontologybuilder_views_components_Relation extends org_glizy_components_ComponentContainer
{
    function process()
    {
    ...
    function createChildComponents()
    {
        ...
        if (is_null($this->_content['__image'])) {
            $c = &org_glizy_ObjectFactory::createComponent('desiderataLibrary.modules.ontologybuilder.views.components.NoImage', $this->_application, $this, 'glz:Image', '__image', '__image');
            $c->setAttribute('width', __Config::get('THUMB_SMALL_WIDTH'));
            $c->setAttribute('height', __Config::get('THUMB_SMALL_HEIGHT'));
            $this->addChild($c);
        }
