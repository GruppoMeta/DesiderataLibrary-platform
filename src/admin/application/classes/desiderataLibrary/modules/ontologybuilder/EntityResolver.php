<?php
class desiderataLibrary_modules_ontologybuilder_EntityResolver extends org_glizycms_speakingUrl_AbstractUrlResolver implements org_glizycms_speakingUrl_IUrlResolver
{
    public function __construct()
    {
        parent::__construct();
        $this->type = 'desiderataLibrary.modules.ontologybuilder.content';
        $this->protocol = 'ontologyContent:';
    }
    ...
    public function compileRouting($ar)
    {
        ...
        return $menu ? '<glz:Route skipLanguage="true" value="'.$ar->language_code.'/'.$ar->speakingurl_value.'" action="show" pageId="'.$menu->id.'" entityTypeId="'.$entityTypeId.'" document_id="'.$ar->speakingurl_FK.'" cms:urlResolver="desiderataLibrary.modules.ontologybuilder.content"  />' : '';
    }
    ...
    {
        $it = org_glizy_objectFactory::createModelIterator('desiderataLibrary.modules.ontologybuilder.models.EntityMenu');
    ...
    public function searchDocumentsByTerm($term, $id, $protocol='', $filterType='')
    {
        ...
        if ($term) {
            ...
            $ar = org_glizy_objectFactory::createModel('desiderataLibrary.modules.ontologybuilder.models.EntityDocument');
