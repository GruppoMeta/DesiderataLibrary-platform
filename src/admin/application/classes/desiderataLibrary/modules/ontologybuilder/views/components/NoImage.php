<?php
class desiderataLibrary_modules_ontologybuilder_views_components_NoImage extends org_glizy_components_Component
{
    function init()
    {
    ...
    function getContent()
    {
        ...
        return array('__html__' => '<img src="'.__Config::get('ontologybuilder.noImage.src').'" width="'.$width.'" height="'.$height.'"/>');
    }
}
?>