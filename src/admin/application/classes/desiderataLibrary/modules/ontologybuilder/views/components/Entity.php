<?php
class desiderataLibrary_modules_ontologybuilder_views_components_Entity extends org_glizy_components_ComponentContainer
{
    function process()
    {
    ...
    function createChildComponents()
    {
        ...
        $localeService = $this->_application->retrieveProxy('desiderataLibrary.modules.ontologybuilder.service.LocaleService');
            ...
            switch ($ar->entity_properties_type) {
                ...
                case 'attribute.imagelist':
                    if ($this->_content[$attribute]) {
                        $c = &org_glizy_ObjectFactory::createComponent('desiderataLibrary.modules.ontologybuilder.views.components.Repeater', $this->_application, $this, 'cmp:Repeater', $attribute, $attribute);
                ...
                case 'attribute.module':
                    $c = &org_glizy_ObjectFactory::createComponent('desiderataLibrary.modules.ontologybuilder.views.components.RepeaterForModule', $this->_application, $this, 'cmp:Repeater', $attribute, $attribute);
                    ...
                    $module = &org_glizy_ObjectFactory::createComponent('desiderataLibrary.modules.ontologybuilder.views.components.Module', $this->_application, $c, 'cmp:Module', 'attaches', 'attaches');
                    $c->addChild($module);
                ...
                default:
                    ...
                    if (!is_null($ar->entity_properties_target_FK_entity_id) && $ar->entity_properties_relation_show != 3 && $this->_content[$attribute]['content']) {
                        ...
                        $relation = &org_glizy_ObjectFactory::createComponent('desiderataLibrary.modules.ontologybuilder.views.components.Relation', $this->_application, $c, 'cmp:Relation', 'attaches', 'attaches');
        ...
        foreach ((array)$this->_content['__reference_relations'] as $entityTypeName => $data) {
            if ($data['show'] != 3) {
                $c = &org_glizy_ObjectFactory::createComponent('desiderataLibrary.modules.ontologybuilder.views.components.Repeater', $this->_application, $this, 'cmp:Repeater', $entityTypeName, $entityTypeName);

                $relation = &org_glizy_ObjectFactory::createComponent('desiderataLibrary.modules.ontologybuilder.views.components.Relation', $this->_application, $c, 'cmp:Relation', 'attaches'.$entityTypeName, 'attaches'.$entityTypeName);
        ...
        if ($entityTypeService->getEntityTypeAttribute($entityTypeId, 'entity_show_relations_graph')) {
            $c = &org_glizy_ObjectFactory::createComponent('desiderataLibrary.modules.ontologybuilder.views.components.DocumentGraph', $this->_application, $this, 'cmp:DocumentGraph', 'document_graph', 'document_graph');
